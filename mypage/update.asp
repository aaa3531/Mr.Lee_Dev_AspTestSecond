...
<SCRIPT language="javascript">
    ...
    function memberChange() {
                var pwd_old = document.getElementById("changepwd_old").value;
...
<!-- container -->
	<div id="container">
      ...
      <input type="hidden" name="flag" value="<%=withdraw_pwd %>" ID="changepwd_old"> 
		<!-- [s]회원정보수정 서식-->
		...
		<dl>
            ...
            <dl>
             ...
             <input type="password" id="changepwd" name="withdraw_pwd" value="<%=withdraw_pwd %>">
             <% else %>
             <input type="password" id="changepwd" name="withdraw_pwd" value="">
             <% end if %>
				</dd>
			</dl>
             <% if userchange_flag = "2" then %>
