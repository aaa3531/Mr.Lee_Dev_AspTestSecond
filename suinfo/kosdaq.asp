...
<%
  ...
  if request("info_no") <> "" then
   ...
   ' terms Detail 뿌리기
  strSQL = "p_sh_info_user_kosdaq_list  "
...
<SCRIPT language="javascript">
	...
	<div id="container">
		...
		<div id="content" class="subcon">
			<div class="snb_title">
				<ul>
				<li class="snb_01">KOSDAQ 증권정보<span>HOME > 증권정보 > KOSDAQ증권정보</span></li>
				</ul>

			</div>
            <% if count > "0" then %>
            <a href="kosdaq_scr.asp?market_cd=KOSDAQ" class="btn_red">정보등록</a>
            <% end if %>
			<!-- <div class="sub_tab">
				<ul>
    ...
    <% 
       Do While Not rsInfo.EOF    %> 
							...
							<tr>
								...
								<td class="board_title">[<%=rsInfo("info_type") %>] <a href="kosdaq.asp?info_no=<%=rsInfo("info_no") %>"><span onclick="javascript:infoCounter(this);" infono="<%=rsInfo("info_no") %>"><%=rsInfo("info_desc") %></span></a></td>
